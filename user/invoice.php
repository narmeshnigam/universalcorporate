...
if (!$orderId) { header('Location: my-orders.php'); exit; }

// Fetch order details
$stmt = $pdo->prepare("SELECT o.*, u.email as user_email FROM orders o LEFT JOIN site_users u ON o.user_id = u.id WHERE o.id = ? AND o.user_id = ?");
...
if (in_array($order['status'], ['pending', 'cancelled'])) {
    ...
    header('Location: my-orders.php?view=' . $orderId);
    exit;
}
...
<body>
    <div class="print-controls">
        <a href="my-orders.php?view=<?php echo $order['id']; ?>" class="btn-back">← Back</a>
